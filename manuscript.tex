...
\documentclass[unnumsec,webpdf,contemporary,large,namedate,figuresright,figuresleft]{oup-authoring-template}% uncomment this line for author year citations and comment the above
...
\title[Detecting Interactions]{Detecting Interactions in Random Forest for Genomic Data}

\author[1,$\ast$]{Hawlader A. Al-Mamun} 
\author[2]{Rob Dunne}
\author[3]{Ross L. Tellam}
\author[4]{Klara Verbyla}

\authormark{Author Name et al.}

\address[1]{\orgdiv{Data61}, \orgname{CSIRO}, \orgaddress{\street{Ecosciences Bldg 41 Boggo Road }, \postcode{Dutton Park 4102}, \state{QLD}, \country{Australia}}}
\address[2]{\orgdiv{Data61}, \orgname{CSIRO}, \orgaddress{\street{Eveleigh Office, 13 Garden Street}, \postcode{2015}, \state{NSW}, \country{Australia}}}
\address[3]{\orgdiv{Agriculture \& Food}, \orgname{CSIRO}, \orgaddress{\street{306 Carmody Rd}, \postcode{St Lucia 4067}, \state{QLD}, \country{Australia}}}
\address[4]{\orgdiv{Agriculture \& Food}, \orgname{CSIRO}, \orgaddress{\street{Street}, \postcode{Postcode}, \state{State}, \country{Australia}}}
...
\abstract{Epistatic interactions can play an important role in the genetic mechanisms that control phenotypic
