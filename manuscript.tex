...
\title{Detection of Ecstatic Interactions in High-Dimensional Genomic Data Using Random Forests}
  
\author[1,2,3]{Hawlader A. Al-Mamun\corref{cor1}}
\ead{halmamun@intergrain.com}
\author[4]{Rob Dunne} %% Author name
\author[5]{Ross L. Tellam}
\author[6]{Klara Verbyla}
...
\affiliation[2]{organization={InterGrain Pty Ltd.},%Department and Organization
...
\affiliation[3]{organization={School of Biological Sciences},%Department and Organization
...
\affiliation[4]{organization={Data61, CSIRO},%Department and Organization
